...
| Live Frontend | [SmartHire AI on Vercel](https://smart-hire-ai-job-portal-internship.vercel.app) |
...
For public portfolio/demo access, keep Vercel Authentication disabled on the frontend project. Visitors should be able to open the live URL directly, while SmartHire's own login system still protects student, recruiter, and admin dashboards.
